...
public interface ExpiringSession extends Session {
     ...
     *            the last accessed time in milliseconds since midnight of 1/1/1970 GMT
     */
     ...
     * 
     * @return the last time the client sent a request associated with the session expressed in milliseconds since
     *         midnight of 1/1/1970 GMT
     */
    long getLastAccessedTime();

    /**
     * Sets the maximum inactive interval in seconds between requests before this session will be invalidated. A
     * negative time indicates that the session will never timeout.
     * 
     * @param interval
    ...
    /**
     * Gets the maximum inactive interval in seconds between requests before this session will be invalidated. A
     * negative time indicates that the session will never timeout.
     * 
     * @return the maximum inactive interval in seconds between requests before this session will be invalidated. A
     *         negative time indicates that the session will never timeout.
     */
