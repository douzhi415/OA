...
/**
 * For {@link SessionRepository} implementations that support it, this event is fired when a {@link Session} is
 * destroyed either explicitly or via expiration.
 * 
 * @author Rob Winch
 * @since 1.0
 * 
...
public class SessionCreatedEvent extends AbstractSessionEvent {
     ...
     * 
     * @param source
     *            The Source of the SessionCreatedEvent
     * @param session
