...
/**
 * For {@link SessionRepository} implementations that support it, this event is fired when a {@link Session} is updated.
 * 
 * @author Rob Winch
 * @since 1.1
 */
...
public abstract class AbstractSessionEvent extends ApplicationEvent {
    ...
    /**
     * Gets the {@link Session} that was destroyed. For some {@link SessionRepository} implementations it may not be
     * possible to get the original session in which case this may be null.
     * 
     * @param <S>
     *            The type of Session
