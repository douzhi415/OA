 ...
 * to get an {@link javax.servlet.http.HttpSession} to be backed by a {@link org.springframework.session.Session}
 * returned by the {@link org.springframework.session.SessionRepository}.
 * 
 ...
 * {@link HttpSessionStrategy#getRequestedSessionId(javax.servlet.http.HttpServletRequest)} . The default is to look in
 * a cookie named SESSION.</li>
 ...
 * 
 * <p>
 * The SessionRepositoryFilter must be placed before any Filter that access the HttpSession or that might commit the
 * response to ensure the session is overridden and persisted properly.
 * </p>
 * 
 * @param <S>
...
public class SessionRepositoryFilter<S extends ExpiringSession> extends
    ...
    private static final Log SESSION_LOGGER = LogFactory
            .getLog(SESSION_LOGGER_NAME);
    ...
    public void setHttpSessionStrategy(HttpSessionStrategy httpSessionStrategy) {
        if (httpSessionStrategy == null) {
            throw new IllegalArgumentException(
                    "httpSessionStrategy cannot be null");
        }
     ...
     */
    public void setHttpSessionStrategy(
            MultiHttpSessionStrategy httpSessionStrategy) {
        if (httpSessionStrategy == null) {
            throw new IllegalArgumentException(
                    "httpSessionStrategy cannot be null");
        }
     ...
     * @since 1.0
     */
    private final class SessionRepositoryResponseWrapper extends
     ...
     * @since 1.0
     */
    private final class SessionRepositoryRequestWrapper extends
        ...
        public String changeSessionId() {
            ...
            SessionRepositoryFilter.this.sessionRepository.delete(session
                    .getId());
        ...
        private boolean isInvalidateClientSession() {
            return (getCurrentSession() == null)
                    && this.requestedSessionInvalidated;
        }
            ...
            if ((requestedSessionId != null)
                ...
                if (session != null) {
                    ...
                    if (SESSION_LOGGER.isDebugEnabled()) {
                        SESSION_LOGGER
                                .debug("No session found by id: Caching result for getSession(false) for this HttpServletRequest.");
                    }
     ...
     */
    static class MultiHttpSessionStrategyAdapter implements
