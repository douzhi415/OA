...
abstract class OnCommittedResponseWrapper extends HttpServletResponseWrapper {
    ...
    /**
     * Invoke this method to disable invoking {@link OnCommittedResponseWrapper#onResponseCommitted()} when the
     * {@link javax.servlet.http.HttpServletResponse} is committed. This can be useful in the event that Async Web
     * Requests are made.
     */
    ...
    /**
     * Makes sure {@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling the superclass
     * <code>sendError()</code>.
     * 
     * @param sc
    ...
    private void checkContentLength(long contentLengthToWrite) {
        ...
        boolean requiresFlush = (bufferSize > 0)
                && (this.contentWritten >= bufferSize);
    ...
    /**
     * Ensures {@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling the prior to methods
     * that commit the response. We delegate all methods to the original {@link java.io.PrintWriter} to ensure that the
     * behavior is as close to the original {@link java.io.PrintWriter} as possible. See SEC-2039
     * 
     * @author Rob Winch
     */
    ...
    /**
     * Ensures{@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling methods that commit the
     * response. We delegate all methods to the original {@link javax.servlet.ServletOutputStream} to ensure that the
     * behavior is as close to the original {@link javax.servlet.ServletOutputStream} as possible. See SEC-2039
     * 
     * @author Rob Winch
     */
