...
/**
 * Allows for easily ensuring that a request is only invoked once per request. This is a simplified version of
...
abstract class OncePerRequestFilter implements Filter {
    ...
    private String alreadyFilteredAttributeName = getClass().getName().concat(
            ALREADY_FILTERED_SUFFIX);

    /**
     * This {@code doFilter} implementation stores a request attribute for "already filtered", proceeding without
     * filtering again if the attribute is already there.
     * 
     * @param request
     *            the request
     * @param response
     ...
     * @throws IOException
     *             in case of I/O operation exception
     */
    public final void doFilter(ServletRequest request,
        ...
        if (hasAlreadyFilteredAttribute) {
            ...
            request.setAttribute(this.alreadyFilteredAttributeName,
                    Boolean.TRUE);
