...
public interface Session {
    ...
    /**
     * Sets the attribute value for the provided attribute name. If the attributeValue is null, it has the same result
     * as removing the attribute with {@link org.springframework.session.Session#removeAttribute(String)} .
     * 
     * @param attributeName
