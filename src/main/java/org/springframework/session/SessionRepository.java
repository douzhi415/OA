...
public interface SessionRepository<S extends Session> {
     ...
     * 
     * <p>
     * This allows optimizations and customizations in how the {@link Session} is persisted. For example, the
    ...
    /**
     * Ensures the {@link Session} created by {@link org.springframework.session.SessionRepository#createSession()} is
     * saved.
     * 
     * <p>
     ...
     * 
     * @param id
     *            the {@link org.springframework.session.Session#getId()} to lookup
     * @return the {@link Session} by the {@link Session#getId()} or null if no {@link Session} is found.
     */
    S getSession(String id);

    /**
     * Deletes the {@link Session} with the given {@link Session#getId()} or does nothing if the {@link Session} is not
     * found.
     * 
     * @param id
     *            the {@link org.springframework.session.Session#getId()} to delete
     */
