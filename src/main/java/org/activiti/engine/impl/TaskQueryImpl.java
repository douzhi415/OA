...
public class TaskQueryImpl extends AbstractVariableQueryImpl<TaskQuery, Task>
    ...
    public TaskQuery taskNameLikeIgnoreCase(String nameLikeIgnoreCase) {
        ...
        if (orActive) {
            currentOrQueryObject.nameLikeIgnoreCase = nameLikeIgnoreCase
                    .toLowerCase();
        } else {
    ...
    public TaskQuery taskAssigneeLikeIgnoreCase(String assigneeLikeIgnoreCase) {
        ...
        if (orActive) {
            currentOrQueryObject.assigneeLikeIgnoreCase = assigneeLikeIgnoreCase
                    .toLowerCase();
        } else {
    ...
    public TaskQuery processInstanceBusinessKeyLikeIgnoreCase(
        ...
        if (orActive) {
            currentOrQueryObject.processInstanceBusinessKeyLikeIgnoreCase = processInstanceBusinessKeyLikeIgnoreCase
                    .toLowerCase();
        } else {
            this.processInstanceBusinessKeyLikeIgnoreCase = processInstanceBusinessKeyLikeIgnoreCase
                    .toLowerCase();
        }
    ...
    public TaskQuery taskVariableValueEquals(String variableName,
        ...
        if (orActive) {
            currentOrQueryObject.variableValueEquals(variableName,
                    variableValue);
        } else {
    ...
    public TaskQuery taskVariableValueNotEquals(String variableName,
            Object variableValue) {
        if (orActive) {
            currentOrQueryObject.variableValueNotEquals(variableName,
                    variableValue);
        } else {
    ...
    public TaskQuery processDefinitionKeyLikeIgnoreCase(
        ...
        if (orActive) {
            currentOrQueryObject.processDefinitionKeyLikeIgnoreCase = processDefinitionKeyLikeIgnoreCase
                    .toLowerCase();
        } else {
    ...
    public List<String> getCandidateGroupsByCandidateOrAssignee() {
